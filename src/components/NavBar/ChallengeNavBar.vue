<template>
  <header class="challenge-navbar">
    <!-- 左侧：动态 Logo -->
    <div class="nav-left" @click="goHome">
      <h1 class="logo-text">
        🏆 Lum<span>Echo</span> Challenges
      </h1>
    </div>
    ...
    <!-- 右侧：功能与用户 -->
    <div class="nav-right">
      <button class="create-btn" @click="$emit('create')" title="发起新挑战">
        <span>✨ 发起挑战</span>
      </button>
...
@media (max-width: 768px) {
  .challenge-navbar { padding: 12px 20px; }
